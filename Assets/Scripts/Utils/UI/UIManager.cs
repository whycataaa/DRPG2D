...
namespace MY_FrameWork
{
    public class UIManager:Singleton<UIManager>
    {
        ...
        public GameObject GetAndShowUI(UIType _UIType)
        {
            ...
            {
                //没有再实例化一个出来
                GameObject UI=GameObject.Instantiate(ResManager.Instance.LoadResource<GameObject>(PathUtils.RES_PATH,PathUtils.UI_AB_PATH,_UIType.Name+".prefab"),go.transform);
